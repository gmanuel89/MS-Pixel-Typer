...
ms_pixel_typer <- function() {
  ...
  ############## INSTALL AND LOAD THE REQUIRED PACKAGES
  install_and_load_required_packages(c("tcltk", "parallel", "caret", "stats", "pROC", "nnet", "e1071", "kernlab", "MASS", "klaR", "pls", "randomForest", "lda", "SparseM", "stringi", "XML", "MALDIquant", "MALDIquantForeign", "doParallel"), repository = "http://cran.mirror.garr.it/mirrors/CRAN/", update_packages = FALSE, print_messages = TRUE)
